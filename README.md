...
We moved [here](https://github.com/eclipse-tractusx/traceability-foss-frontend) and the actual development takes place [here](https://github.com/catenax-ng/tx-traceability-foss-frontend)
